  ...
  return (
    ...
    >
      <div className="flex gap-3 mb-6 mt-2">
        ...
        <a href="/practice/my-transfers" className="text-sm px-4 py-2 rounded-lg bg-card text-foreground font-medium card-shadow hover:bg-accent transition-colors">My Transfers</a>
      </div>
